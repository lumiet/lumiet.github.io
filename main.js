...
function updateatk() {
	...
	for(var i=0;i<player.atk.length;i++) {
		player.atk[i].time++;
		if(i==player.currentatk) player.atk[i].buttnborder.color = "red";
		else player.atk[i].buttnborder.color = "#000";
	...
	for(var i=0;i<enemy.atk.length;i++) {
		enemy.atk[i].time++;
		if(i==enemy.currentatk) enemy.atk[i].buttnborder.color = "red";
		else enemy.atk[i].buttnborder.color = "#000";
