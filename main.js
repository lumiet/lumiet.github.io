...
if(alignment==true){
     ...
     this.hpbar = new component(20, 100, "#23fc6f", canvas.width-110,canvas.height-100);
  this.basehpbar = new component(20,300,"#212121",canvas.width-110,canvas.height-100);
}  
else {
